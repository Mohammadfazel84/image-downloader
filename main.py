    ...
    def download(self,pcount):
        ...
        for i in range(1, pcount+1):
            ...
            try:
                ...
                pass
            try:
                self.driver.find_element(By.XPATH,f'//*[@id="zci-images"]/div[2]/div/div[1]/div[{1 if i==1 else 2}]/div/div[1]/div/a/img[2]').screenshot(f'C:/Users/IT/Pictures/imagedownloader/{self.phrase} {i}.png') # .get_attribute('href')
            except:
                pass
        self.driver.quit()
def run():
